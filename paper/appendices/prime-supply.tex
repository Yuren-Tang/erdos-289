...
The proof needs only one fixed-ratio prime band with two-sided order of magnitude $X/\log X$.  We record an elementary Chebyshev proof.
...
Choose one fixed $\Lambda>1$ with $C_\theta<c_\theta\Lambda$.  Then
\[
