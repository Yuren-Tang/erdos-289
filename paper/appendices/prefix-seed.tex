...
\begin{proof}
The explicit witness below proves the first three assertions by exact rational identities and finite separation checks, with the uniform separation estimate beginning at \eqref{eq:successive-row-gap}.  The fourth follows from \eqref{eq:finite-seed-bound} and \eqref{eq:future-bridge-total}.  The ancillary script independently replays the displayed finite rational identities and separation inequalities; it is not used as a proof oracle for the uniform argument.
\end{proof}
