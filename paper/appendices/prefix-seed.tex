...
\begin{proof}
The explicit witness below proves the first three assertions by exact rational identities and finite separation checks, with the uniform separation estimate beginning at \eqref{eq:successive-row-gap}.  The fourth follows from \eqref{eq:finite-seed-bound} and \eqref{eq:future-bridge-total}.  The ancillary script independently checks the displayed finite rational identities and separation inequalities.  The uniform argument beyond this finite certificate is proved below.
\end{proof}
...
These finite checks are also carried out, using exact rational arithmetic, by the ancillary script \texttt{tools/verify\_prefix\_seed.py}.  The script is verification of the displayed finite certificate; the argument below supplies the uniform proof beyond it.
