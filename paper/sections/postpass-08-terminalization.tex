...
By Proposition~\ref{prop:finite-realization}, choose a finite covering labelled relation $R_X$ with target $T_X$, all of whose edge labels have reciprocal value below $2$.  Let
\[
...
\end{CD}
\end{equation}
Since $\tau_X$ is surjective, the left vertical map is surjective.  Thus $E_{X,k}$ is nonempty.  An element of $E_{X,k}$ has an interval-configuration label $S\in\mathcal C$ satisfying
