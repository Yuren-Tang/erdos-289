...
This section certifies the local arithmetic resource cell at a prime-power stage.  For every sufficiently large $Q=p^e$ we construct a finite family $\mathcal A_Q\subset\mathcal C$, its simple-quotient map $\phi_Q:\mathcal A_Q\to S_Q^\times$, and the density, fibre, incompatibility, support and reciprocal-mass bounds consumed later.  No global choices of compatible rows are made here.
