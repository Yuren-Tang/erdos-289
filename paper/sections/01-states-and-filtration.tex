...
For a finite composable string $R_1,\ldots,R_n$, let $P_n$ be the fibre product of the edge sets over the intermediate sets.  The labels define a map $\ell:P_n\to\mathcal C^n$.  The obstruction to strictness is exactly whether $\ell$ factors through the joint-compatibility domain:
