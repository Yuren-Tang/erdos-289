...
=o(Q/\log Q).
\end{equation}
By Proposition~\ref{prop:signed-inverse-capabilities}, these envelopes are incompatible with only $o(Q/\log Q)$ members of $\mathcal A_Q$.  The fixed finite seed contributes only $O(1)$ further bounded-size exclusion envelopes, and hence excludes only $O(1)$ additional members of $\mathcal A_Q$.
